 ...
 */
	...
	{
		getJSObject().executeScript("arguments[0].scrollToElement(true)", element);
		}
	/**
	 * THe method  scrolls the page up based on the pixel parameter.
	 * 
	 * @param pixel
	 */
	...
	/**
	 * THe method  scrolls the page down based on the pixel parameter.
	 * 
	 * @param pixel
	 */
